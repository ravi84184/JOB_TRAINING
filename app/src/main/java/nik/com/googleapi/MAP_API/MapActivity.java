package nik.com.googleapi.MAP_API;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, DirectionFinderListener,LocationListener,GoogleApiClient.OnConnectionFailedListener{
...
//                    //geoLocate(etOrigin.getText().toString());
//                }
//
//                return false;
//            }
        ...
        etDestination.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView textView, int actionId, KeyEvent keyEvent) {
                if(actionId == EditorInfo.IME_ACTION_DONE
                    ...
                    //execute our method for searching
                    String dName = etDestination.getText().toString();
//                    geoLocate(dName);
                    sendRequest();
    ...
    private void geoLocate(String lName){
        Log.d(TAG, "geoLocate: geolocating");

        String searchString = lName;
